...
# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/7.3.0/include/stddef.h" 1 3 4
# 216 "/usr/lib/gcc/x86_64-pc-linux-gnu/7.3.0/include/stddef.h" 3 4
...
# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/7.3.0/include/stdarg.h" 1 3 4
# 40 "/usr/lib/gcc/x86_64-pc-linux-gnu/7.3.0/include/stdarg.h" 3 4
...
# 4 "cclass.c"
struct vector;
typedef void (* push_back_rcpp_t)(struct vector *this, int);
typedef int (* at_rcpp_t)(struct vector *this, int);

struct vector {
push_back_rcpp_t push_back;
at_rcpp_t at;
};
...
int main(){
    struct vector vct __attribute__((cleanup(vector_destructor)));vector_constructor(&vct,
# 30 "cclass.c" 3 4
   ((void *)0)
# 30 "cclass.c"
   );
