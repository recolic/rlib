...
#   endif
        ...
        void set_log_level(int max_level) {
        ...
        void log(int level, const std::string &info, Args ... extra_args) const {
        ...
        int register_log_level(const std::string &name) {
            ...
            int new_level = (int)impl::max_predefined_log_level;
...
#undef RLIB_IMPL_MACRO_LOG_ADD_SHORTHAND
    ...
    private:
        static constexpr const char * predefined_log_level_name(int level) noexcept {
            switch(level) {
        ...
        static constexpr bool is_predefined_log_level(int level) noexcept {
            return predefined_log_level_name(level)[0] != '\0';
        }
        std::string log_level_name(int level) const noexcept {
        ...
        std::list<std::pair<int , std::string> > custom_log_level_names;
        intlog_level = log_level_t::INFO; // `Ignore` deadline.
